...
[상담 로직 예시]
"지수님, 가끔은 주변에서 '성격이 좀 모나다'거나 '예민하다'는 소리를 들을 때도 있었죠? 사실 그건 지수님이 남들보다 세상을 더 깊게 느끼고, 대충 살고 싶지 않아서 그런 거잖아요.
남들은 모르는 그 속앓이 하느라 얼마나 힘들었겠어요. 하지만 올해는 그 날카로운 시선을 조금만 거두고, 지수님 자신에게 좀 더 너그러워졌으면 좋겠어요. 충분히 잘하고 있으니까요, 안 그래요?"
